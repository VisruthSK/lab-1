...
```{r}
# should probably use separate_wider_regex instead
clean_mpg <- clean_mpg |>
  separate_wider_delim(trans, "(", names = c("trans_style", "trans_type")) |>
  mutate(trans_type = str_sub(trans_type, end = -2))
```
